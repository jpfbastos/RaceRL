    ...
    def train_agent(self, n_epochs, train_seeds=20, val_seeds=5):
        ...
        for epoch in range(n_epochs):
            ...
            if epoch % 20 == 0 and best_actor_state is not None:
                torch.save(best_actor_state, '../models/a2c_actor.pt')
                torch.save(best_critic_state, '../models/a2c_critic.pt')

        torch.save(best_actor_state, '../models/a2c_actor_final.pt')
        torch.save(best_critic_state, '../models/a2c_critic_final.pt')

    def play(self, actor_filename='../models/a2c_actor_final.pt', critic_filename='../models/a2c_critic_final.pt'):
        """
